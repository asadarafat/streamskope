...
export const ELECTRON_RUNTIME_EFFICIENCY_POLICY = Object.freeze({
  backgroundWorkOwnerFiles: Object.freeze([
    "src/kafka/application/session.ts",
    "src/kafka/application/trust-acquisition-service.ts",
    "src/kafka/facade/facade-support.ts",
    "src/kafka/engine/engine.ts",
    "src/kafka/engine/platformatic-latency.ts",
    "src/kafka/ui/LatencyWorkspace.tsx",
    "src/kafka/ui/OperationalPreferencesDialog.tsx",
    "src/kafka/ui/TrustRecipeManager.tsx",
    "src/kafka/ui/stream-monitor-observer.ts",
    "src/main/electron-profile-protection.ts",
    "src/main/electron-event-delivery.ts",
    "src/main/ssh2-kafka-remote-session.ts",
    "src/main/ssh2-kafka-remote-trust-adapter.ts",
  ]),
