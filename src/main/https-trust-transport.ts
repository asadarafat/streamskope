...
import { parseHttpsUrl, validateHttpsHeader } from "../kafka/contracts/https-trust-validation";
import {
...
import { canonicalCertificates } from "../kafka/engine/trust-material-shared";
